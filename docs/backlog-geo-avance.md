...
- A25 — Aligner le scoring sur le guide officiel Google « AI features » (developers.google.com/search/docs/appearance/ai-features) : vérifier qu'aucun blocage involontaire de Google-Extended n'empêche l'éligibilité AI Overviews, et exiger les données structurées qu'il recommande. | Impact fort / effort moyen
...
- A27 — Commande generate : remplacer les placeholders TODO du llms.txt généré par du contenu dérivé du crawl (titres/descriptions réels) — generate.test.ts:158 accepte encore /todo|paste/, signe de sortie inachevée. | Impact fort / effort faible
...
- A29 — Élargir SOCIAL_RE (packages/cli/src/checks/llm-content.ts:392) : bsky.app, discord.gg/.com, whatsapp.com, twitch.tv manquent — faux signaux possibles sur les liens sociaux. | Impact faible / effort faible
