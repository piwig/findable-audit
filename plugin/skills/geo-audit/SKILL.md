...
Audit a live website's readiness for AI search (GEO) and technical SEO using the `findable-audit` CLI (113 checks across 8 families), then turn the raw report into a prioritized, actionable fix plan.
...
- The 8 families (113 checks): `ai-access` (9), `llm-content` (14),
