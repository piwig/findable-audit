...
export const CHECK_MESSAGES_FR: Record<string, string> = {
  ...
  // A71 — rsl-license (ai-access).
  'RSL license declared via <link rel="license"> ({0}) and robots.txt "License:" ({1})': 'licence RSL déclarée via <link rel="license"> ({0}) et via la directive "License:" du robots.txt ({1})',
  'RSL license declared via <link rel="license" href="{0}">': 'licence RSL déclarée via <link rel="license" href="{0}">',
  'RSL license declared via robots.txt "License: {0}"': 'licence RSL déclarée via la directive "License: {0}" du robots.txt',
  'no RSL (Really Simple Licensing) declaration found — no <link rel="license"> on the homepage, no "License:" directive in robots.txt': "aucune déclaration RSL (Really Simple Licensing) trouvée — pas de <link rel=\"license\"> sur la page d'accueil, pas de directive \"License:\" dans le robots.txt",
  ...
  // Grappe liens (#26/#48/#49/#50/#51) — profil d ancres, contextuel vs structurel,
  // fuites d equite interne, vivacite des liens sortants
  "fewer than 2 internal targets with a gradable anchor profile": "moins de 2 cibles internes ont un profil d’ancres évaluable",
  "anchor text does not name the target: {0}": "le texte du lien ne nomme pas sa cible : {0}",
  "every in-content link repeats one anchor: {0}": "tous les liens en contenu répètent la même ancre : {0}",
  "anchor text names the target on {0} internal page(s)": "le texte des liens nomme sa cible sur {0} page(s) interne(s)",
  "fewer than 5 sampled pages — contextual vs boilerplate links are not separable": "moins de 5 pages échantillonnées — impossible de distinguer liens contextuels et liens de gabarit",
  "only {0}% of internal links sit in the main content ({1}/{2})": "seulement {0} % des liens internes sont dans le contenu principal ({1}/{2})",
  "{0}% of internal links sit in the main content ({1}/{2}); {3} substantial page(s) link out only from the template": "{0} % des liens internes sont dans le contenu principal ({1}/{2}) ; {3} page(s) substantielle(s) ne lient que depuis le gabarit",
  "{0}% of internal links sit in the main content ({1}/{2})": "{0} % des liens internes sont dans le contenu principal ({1}/{2})",
  "internal links that block their own equity: {0}": "liens internes qui bloquent leur propre transmission : {0}",
  "no rel=\"nofollow\" on {0} internal link(s); {1} point at a noindex page, {2} at an error page": "aucun rel=\"nofollow\" sur {0} lien(s) interne(s) ; {1} pointent vers une page en noindex, {2} vers une page en erreur",
  "no equity-blocking rel on {0} internal link(s)": "aucun rel bloquant sur {0} lien(s) interne(s)",
  "outbound links not probed — pass --check-outbound to check them": "liens sortants non sondés — utilisez --check-outbound pour les vérifier",
  "no outbound links on sampled pages": "aucun lien sortant sur les pages échantillonnées",
  "{0}/{1} outbound link(s) resolve ({2} unverifiable, {3} declaring rel)": "{0} lien(s) sortant(s) sur {1} répondent ({2} invérifiable(s), {3} déclarant un rel)",
  "dead outbound link(s): {0}": "lien(s) sortant(s) morts : {0}",
