...
147 checks across 8 weighted families — AI crawler access, answer-engine content,
...
- **Check guide**: every one of the 147 checks documented — what it verifies, why it
